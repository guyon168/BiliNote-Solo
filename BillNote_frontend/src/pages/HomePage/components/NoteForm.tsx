...
import { generateNote, importNote } from '@/services/note.ts'
...
const NoteForm = () => {
  ...
  /* ---- 全局状态 ---- */
  const { addPendingTask, currentTaskId, setCurrentTask, getCurrentTask, retryTask, updateTaskContent } =
    useTaskStore()
  ...
  const FormButton = () => {
    ...
    return (
      <div className="flex gap-2">
        ...
        {!editing && (
          <Button type="button" variant="outline" size="icon" onClick={handleImportClick}>
