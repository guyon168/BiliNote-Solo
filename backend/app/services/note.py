...
# 统一从 path_helper 获取，不再直接读环境变量
from app.utils.path_helper import get_note_output_dir, get_screenshots_dir
NOTE_OUTPUT_DIR = Path(get_note_output_dir())
IMAGE_OUTPUT_DIR = get_screenshots_dir()
